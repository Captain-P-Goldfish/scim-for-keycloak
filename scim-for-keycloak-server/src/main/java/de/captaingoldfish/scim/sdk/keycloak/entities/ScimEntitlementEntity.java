...
public class ScimEntitlementEntity
{
  ...
  /**
   * the display value of the entitlement
   */
  @Column(name = "ENTITLEMENT_DISPLAY")
  ...
  /**
   * if this is the primary entitlement or not
   */
  ...
  @Builder
  public ScimEntitlementEntity(String id,
                               String value,
                               String display,
                               String type,
                               boolean primary,
